...
//    'slack_webhook_urls' => env('SLACK_WEBHOOK_URL', ''),
    'slack_webhook_urls' => [
        '#invalid_urls' => env('SLACK_WEBHOOK_INVALID_URLS'),
        '#logging' => env('LOG_SLACK_WEBHOOK_URL'),
        '#app_messages' => env('SLACK_WEBHOOK_URL'),
    ],
    /*
    |--------------------------------------------------------------------------
    | Default Channel
